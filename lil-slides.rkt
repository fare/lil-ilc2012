...
and it is special style called Interface-Passing Style.
...
#|
The issue of Polymorphism is to
consider an informal protocol
of some functions and data structures,
and find ways for both implementers and users of the protocol
...
and select the correct method to use to use
...
#|
No let's discuss Parametric Interfaces
|#
(slide #:title (title "Parametric Interfaces")
  (code
   (lookup <alist>
